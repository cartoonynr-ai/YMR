...
import { getOrders } from '../../data/mockOrderData'
import { getProducts } from '../../data/mockInventory'
...
export default function KpiCards() {
  ...
  useEffect(() => {
    ...
    const fbOrders = orders.filter(o => o.channel === 'FB' || o.channel === 'FACEBOOK').length
    const posOrders = orders.filter(o => o.channel === 'POS' || o.channel === 'STOREFRONT').length
